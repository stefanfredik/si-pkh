    ...
    <div class="container">
        <div style="text-align: center; ">
            ...
            <div style="display: inline-block; text-align: center; margin: 0 80px;">
                ...
                <p style="margin: 0; font-weight: bold;">KECAMATAN KUWUS BARAT</p>
                <p style="margin: 0; font-size: small;">DESA KOLANG</p>
            </div>
        ...
        <div>
            ...
            <p style="text-align: right;"><?php echo "Kuwus, " . date('d-m-Y'); ?></p>
        ...
        <div class="footer">
            ...
            <div>
                <p style="font-weight: bold; margin: 0;">(______________________)</p>
