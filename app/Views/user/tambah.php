                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input required name="no_nik" class="form-control <?= $validation->hasError('no_nik') ? 'is-invalid' : ''; ?> " type="text" placeholder="Masukan NIK" value="<?= set_value('no_nik'); ?>">
                                <div class="invalid-feedback">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input required name="alamat" class="form-control <?= $validation->hasError('alamat') ? 'is-invalid' : ''; ?> " type="text" placeholder="Alamat" value="<?= set_value('alamat'); ?>">
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input required name="telepon" class="form-control <?= $validation->hasError('telepon') ? 'is-invalid' : ''; ?> " type="text" placeholder="Masukan Nomor Telepon" value="<?= set_value('telepon'); ?>">
                                <div class="invalid-feedback">
