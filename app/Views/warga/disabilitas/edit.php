                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input value="<?= $warga['nama_pengasuh']; ?>" required name="nama_pengasuh" class="form-control" type="text">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input value="<?= $warga['nama_ibukandung']; ?>" required name="nama_ibukandung" class="form-control" type="text">
                            </div>
                        </div>
                    </div>
