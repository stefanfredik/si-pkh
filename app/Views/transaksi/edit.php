...
<div class="container-fluid py-4">
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <?= form_open("/" . $info['url'] . "/" . $transaksi['id'], ['class' => "needs-validation"]); ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input required value="<?= $transaksi['jumlah']; ?>" name="jumlah" class="form-control" type="text" placeholder="Masukan Jumlah Uang">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input required value="<?= $transaksi['tanggal_transaksi']; ?>" name="tanggal_transaksi" class="form-control" type="date">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="keterangan" id="" rows="5"><?= $transaksi['keterangan']; ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
